...
#if defined(__CC_ARM)
  /*
   * ARMCC5 propagates __packed to array member pointer types.  The generated
   * helpers then reject those pointers when passed to memcpy-style APIs.
   * The ARMCC5 integration forces MAVLINK_ALIGNED_FIELDS=0, so wire encoding
   * is performed field by field and does not depend on structure packing.
   */
  #pragma anon_unions
